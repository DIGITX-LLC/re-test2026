...
export const ValueProp = () => {
  return (
    <section id="about" className="relative lg:py-24 bg-black overflow-hidden">
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          ...
          >
            ...
            <p className="text:sm md:text-base lg:text-lg text-zinc-400  mb-8 leading-relaxed">
          ...
          >
            ...
            <div className="relative grid grid-cols-1 sm:grid-cols-2 gap-4">
              ...
              <div className="bg-zinc-900/50 backdrop-blur-xl border border-white/10 rounded-2xl p-6 hover:border-red-500/30 transition-colors group">
                ...
                <h3 className="text:sm lg:text-lg font-semibold text-white mb-2">Code Integrity</h3>
              ...
              <div className="bg-zinc-900/50 backdrop-blur-xl border border-white/10 rounded-2xl p-6 hover:border-red-500/30 transition-colors group sm:translate-y-8">
                ...
                <h3 className="text-sm lg:text-lg font-semibold text-white mb-2">User Ready</h3>
              ...
              <div className="bg-zinc-900/50 backdrop-blur-xl border border-white/10 rounded-2xl p-6 hover:border-red-500/30 transition-colors group sm:-translate-y-8">
                ...
                <h3 className="taxt:sm lg:text-lg font-semibold text-white mb-2">Production Safe</h3>
               ...
               <div className="bg-zinc-900/50 backdrop-blur-xl border border-white/10 rounded-2xl p-6 hover:border-red-500/30 transition-colors group">
                ...
                <h3 className="text-sm lg:text-lg font-semibold text-white mb-2">Launch Speed</h3>
